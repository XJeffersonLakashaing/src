...
const quizdata = [{
    question: "Which Java keyword is use to import package",
    options: ["this", "import", "throws", "goto"],
    answer: "import",
    category: 1
  },
  {
    question: "Which Java keyword is the property of Inheritance",
    options: ["private", "protected", "public", "Exception"],
    answer: "public",
    category: 2
  },
  {
    question:"What is an example of explicit type conversion",
    options: ["float f=10.0 sum=10+f", "int a=(int)c", "10.0(10)", "10(10.0"],
    answer: "int a=(int)c",
    category: 3
  },
];
